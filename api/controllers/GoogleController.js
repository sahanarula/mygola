...
module.exports = {
	index: function(req, res){
		...
		sails.request('https://maps.googleapis.com/maps/api/place/nearbysearch/json?location='+ latFinal +','+ lonFinal +'&radius=' + radius + '&types=amusement_park|doctor|food|gym|zoo|shopping_mall|restaurant|night_club|hospital|lodging&key=' + sails.conf.api_key + '&sensor=true', function (error, response, body) {
